 ...
 */
final class Version20220109005941 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne ADD profile_id INT DEFAULT NULL, ADD job_id INT DEFAULT NULL, DROP jog');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne ADD jog VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP profile_id, DROP job_id');
    }
}
